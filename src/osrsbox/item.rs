...
mod tests {
    ...
    fn deserialize_weapon() -> Result<()> {
...

        {
            ...
            assert_eq!(s.attack_type(), AttackType::Slash);
            assert_eq!(s.attack_style(), AttackStyle::Accurate);
        }

        {
            ...
            assert_eq!(s.attack_type(), AttackType::Slash);
            assert_eq!(s.attack_style(), AttackStyle::Controlled);
        }

        {
            ...
            assert_eq!(s.attack_type(), AttackType::Slash);
            assert_eq!(s.attack_style(), AttackStyle::Defensive);
        }
